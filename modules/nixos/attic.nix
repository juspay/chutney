...
in
{
  services.atticd = {
    ...
    settings = {
      ...
      # FIXME: Uncomment after domain is assigned
      # api-endpoint = "https://${domain}/";
      # allowed-hosts = [
      #   domain
      # ];

      # TODO: Consider minio first before adding S3
      # TODO: Add S3
      # storage = {
      #   type = "s3";
      #   region = "ap-south-1";
  ...
  # TODO: setup nginx with zstd module (see cache-server.nix for inspiration)
